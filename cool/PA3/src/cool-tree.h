...
public:
   ...
   virtual Symbol get_name() = 0;       // get class name
   virtual Symbol get_father() = 0;     // get parent name
   virtual Features get_features() = 0; // get feature
   std::unordered_map<Symbol, Feature> *methods;
   std::unordered_map<Symbol, Feature> *attrs;
#ifdef Class__EXTRAS
   Class__EXTRAS
#endif
};
...
public:
   ...
   virtual Symbol get_name() = 0; // get feature name
   virtual Symbol get_type() = 0; // get feature type
   // virtual Formals get_formals() = 0;
   virtual void _get_type() = 0; // get the real type
...
public:
   ...
   virtual Symbol get_name() = 0; // get formal name
   virtual Symbol get_type() = 0; // get formal type
...
public:
   ...
   void dump(ostream &stream, int n); //========= program::dump===done
...
public:
   ...
   Class_ copy_Class_();
   void dump(ostream &stream, int n); // done

   Symbol get_name() // get class name
   {
      return name;
   }
   Symbol get_father() // get parent node name
   {
      return parent;
   }
   Features get_features() // get features
   {
      return features;
   }
...
public:
   ...
   void dump(ostream &stream, int n); // method::dump=========== // done
   ...
   void _get_type(); // method::_get_type======
